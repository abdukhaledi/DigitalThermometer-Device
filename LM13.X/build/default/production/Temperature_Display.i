...
#pragma config EBTRB = OFF
# 13 "./PIC18F4550_ADC_Header_File.h" 2

void ADC_Init();
int ADC_Read(int);
# 12 "Temperature_Display.c" 2
...
void main()
{
    ...
    while(1)
    {
        ...
        sprintf(Temperature,"%d C ",(int)celsius);
